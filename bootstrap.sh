...
# 16/03/2019	MG	1.3.9	Add support for non-option arguments	#
...
readonly version=1.3.9+rc1		# set version variable
readonly packageversion=1.2.13+rc1	# Version of the complete package
